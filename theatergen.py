...
def generate_single_object_with_box(
    ...
    **kwargs,
    ...
    while True:
        ...
        input_latents = get_input_latents_lne(idx, adapter, model_dict=models.model_dict, **arg_dict_l)
...
def run(
    ...
    with torch.autocast("cuda", enabled=use_autocast):
        ...
        input_latents_list, latents_bg, fg_seed_list = latents.get_input_latents_list(models.model_dict, adapter=adapter ,bg_seed=bg_seed,fg_seed_start=fg_seed_start,so_boxes=so_boxes,fg_blending_ratio=fg_blending_ratio,height=height,width=width,verbose=False)
        ...
        (
            ...
            inp_mask,
            inp_img,
        ) = latents.compose_latents_with_alignment(basever, adapter, repeat_ind, mask_tensor_list_512, single_obj_img_list, models.model_dict,latents_all_list,mask_tensor_list,num_inference_steps,overall_batch_size,height, width,latents_bg=latents_bg,

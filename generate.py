...
if args.sd_version == '1.5':
    basever = '1.5'
    base_model_path = "CompVis/stable-diffusion-v1-4" # No need to downlaod
    vae_model_path = "/home/softbuilders/Desktop/TheaterGen/1.5/vae/vae" #Download
    unet_path = "/home/softbuilders/Desktop/TheaterGen/1.5/unet/unet" #Download
    image_encoder_path = "/home/softbuilders/Desktop/TheaterGen/1.5/image_encoder" #Download
    ip_ckpt = "/home/softbuilders/Desktop/TheaterGen/1.5/adapter/ip-adapter_sd15.bin" #Download
    ...
    vae = AutoencoderKL.from_pretrained("/home/softbuilders/Desktop/TheaterGen/1.5/vae/vae").to(dtype=torch.float16)
    unet = UNet2DConditionModel.from_pretrained("/home/softbuilders/Desktop/TheaterGen/1.5/unet/unet").to(dtype=torch.float16)

    # vae = AutoencoderKL.from_pretrained(vae_model_path).to(dtype=torch.float16)
    # unet = UNet2DConditionModel.rom_pretrained(base_model_path + "/unet").to(dtype=torch.float16)
...
if sam_model_dict is None:
    raise RuntimeError("Failed to load SAM model or processor.")

# Store in global model dictionary
models.model_dict = {}
models.model_dict['sam_model_dict'] = sam_model_dict
